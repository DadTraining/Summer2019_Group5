...
bool MainMenuScene::init()
{
	...
	//add back ground 
	background = Sprite::create("Sprites/Background/rsz_background_bb.png");
	...
	logo = Sprite::create("Sprites/Logo/logoName.png");
	...
	itemMarksman = Sprite::create("Sprites/Hero/walk_70000.png");
...
{
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("menuHero1.plist", "menuHero1.png");
	...
	for (int index = 0; index < numberSprite; index++)
	{
		...
		sprintf(spritesFramByName, "%d", index);
		str = str + spritesFramByName + ".png";
